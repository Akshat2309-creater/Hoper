    ...
    <section id="contact" className="py-12 sm:py-16 md:py-20 px-4 bg-secondary">
      <div className="container mx-auto max-w-6xl text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl text-secondary-foreground/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
          {t("cta.desc") || "Join thousands of others who have found hope, support, and healing through our community. Your journey to better mental health starts here."}
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
          ...
          >
            {t("cta.btn") || "Get Started Today"} <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
          </Button>
          <Button 
            size="lg" 
            variant="navbar" 
