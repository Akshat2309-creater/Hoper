  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom Hoper palette — driven by CSS variables (day / .dark)
        "golden-yellow": "hsl(var(--golden-yellow) / <alpha-value>)",
        "deep-purple": "hsl(var(--deep-purple) / <alpha-value>)",
        "soft-lavender": "hsl(var(--soft-lavender) / <alpha-value>)",
        "mint-green": "hsl(var(--mint-green) / <alpha-value>)",
        ...
        "chat-surface": "hsl(var(--chat-surface) / <alpha-value>)",
        "chat-thread": "hsl(var(--chat-thread) / <alpha-value>)",
      },
      borderRadius: {
        lg: "var(--radius)",
